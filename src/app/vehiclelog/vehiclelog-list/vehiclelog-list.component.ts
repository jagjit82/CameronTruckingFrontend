...
@Component({
  ...
  templateUrl: "./vehiclelog-list.component.html",
  styleUrls: ["./vehiclelog-list.component.css"],
  providers:[VehicleLogService]
})
export class VehicleLogListComponent implements OnInit {
  ...
  reloadData() {
    this.sortField="repairDate";
    this.sortOrder="ascending";
    this.vehicleService.getVehicleLogsListPage(0,this.sortField,this.sortOrder,this.company).subscribe(
      data=>{
