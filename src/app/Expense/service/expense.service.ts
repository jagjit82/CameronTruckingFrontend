...
export class ExpenseService {
  ...
  private baseUrl = environment.baseUrl+'/expense';
  private baseUrl1 ='/export/expense';
  ...
  updateexpense(expense:Object): Observable<Object> {
    return this.http.post(`${this.baseUrl}/update`, expense);
  }
  deleteexpense(id: number): Observable<any> {
    return this.http.delete(`${this.baseUrl}/${id}`, { responseType: 'text' });
  }
  getexpensesListPage(): Observable<any> {
 ...
 let options = {
  headers: headers
    ...
    return this.http.get(`/ramdascoldchain/export/expense`, options
        );
}
  ...
  exportexpensesList(){
    ...
    //return this.http.get(`/ramdascoldchain/export/expense`,httpOptions);
  ...
  // }
  getPostexpense(id: number): Observable<Object> {
    return this.http.post(`${this.baseUrl}/get`,id);
  }
  allUnmappedexpenses(): Observable<any> {
    console.log("----------=====>>")
    return this.http.get(`${this.baseUrl}/allUnmappedexpenses`);
  }
